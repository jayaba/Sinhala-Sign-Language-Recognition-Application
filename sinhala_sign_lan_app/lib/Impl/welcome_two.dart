...
import 'package:sinhala_sign_lan_app/Impl/welcome_three.dart';
import 'package:sinhala_sign_lan_app/app_colors.dart';
import 'package:sizer/sizer.dart';

class WelcomeSecPage extends StatelessWidget {
  const WelcomeSecPage({ Key? key }) : super(key: key);
    ...
    return Scaffold(
      ...
      body: Column(children: [
          ...
          child: Center(
            child: Container(
             ...
             // color: colors.welcomeBoardColor,
              ...
              child: Image.asset("assets/images/welcomeThird.png"),
            ),
          ),
        ),
        // SizedBox(
        ...
        Container(
          ...
          child: Text(
            "Sign language is the bridge that connects us to the world",
          ...
          child: TextButton(
            onPressed: () {
              Navigator.push(
                context,
                MaterialPageRoute(
                  builder: (context) => WelcomeThreePage(),
                ),
              );
            },
            child: Text(
